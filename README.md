...
Note that all commands (except like, unlike, later, unalter, aside and unaside) above can be applied on another user by prefixing them by `@username`. If the user has restricted access an Unauthorized resource may be returned though.
